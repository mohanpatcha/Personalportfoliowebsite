...
// Image imports
const parkMeIntro =
  "https://images.unsplash.com/photo-1703978959521-a1950df85332?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx1bmRlcmdyb3VuZCUyMHBhcmtpbmclMjBnYXJhZ2UlMjBjb25jcmV0ZSUyMG1pbmltYWwlMjBtb2Rlcm58ZW58MXx8fHwxNzcxNTAyMzg2fDA&ixlib=rb-4.1.0&q=80&w=1080";
const parkMeScreens =
  "https://images.unsplash.com/photo-1560707303-4e980ce876ad?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtb2JpbGUlMjBhcHAlMjBkcmlua3MlMjBzbWFydHBob25lfGVufDF8fHx8fDE3NzE1MDU3NDJ8MA&ixlib=rb-4.1.0&q=80&w=1080";
          ...
          >
            ...
            <div className="flex flex-col gap-4 text-sm text-neutral-500">
              ...
              <div className="flex gap-4 mt-2">
                <a
                  href="https://www.instagram.com/always.mohan/"
                  target="_blank"
                ...
                <a
                  href="https://www.linkedin.com/in/mohanpatcha/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="uppercase tracking-widest hover:text-black"
                >
                ...
                <a
                  href="https://dribbble.com/mohanpatcha"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="uppercase tracking-widest hover:text-black"
                >
                ...
                <a
                  href="https://www.behance.net/mohanpatcha"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="uppercase tracking-widest hover:text-black"
                >
...
const Hero = ({ onContactClick }: { onContactClick: () => void }) => {
  ...
  return (
    <section
      id="hero"
      className="relative px-6 md:px-12 py-12 md:py-20 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-12 items-center"
    >
      <div className="md:col-span-5 flex flex-col gap-6 z-10">
        ...
        >
          <p className="text-lg md:text-xl text-neutral-600 font-serif italic">
            Hey, I'm Mohan,
          </p>
      ...
      <div className="flex flex-col md:flex-row gap-12 items-start justify-between">
        ...
        <div className="md:w-2/3 flex flex-col gap-8">
          <p className="text-lg text-neutral-600 font-light leading-relaxed">
            I have been practising UX over a decade. I was playing multiple
            roles in the UX arenas. My passion is to transform customer’s vision
            into design that solve their unmet needs. I am open to any roles
            that allow me to provide my innovative ideas for enhancing the
            product design.
          </p>

          <div className="border-l-4 border-black pl-6 py-2">
            <p className="text-2xl md:text-3xl font-serif italic text-neutral-900 leading-tight">
              "Putting user into the design process is very difficult for UX.
              One of the best way is Design thinking."
            </p>
          </div>

          <div className="space-y-6 text-neutral-600 font-light leading-relaxed">
            <p>
              I have over 11+ years of experience in the IT industry where I
              played a variety of roles that started as a creative designer
              which has lead to Innovation and Global Strategy while designing
              product in multiple organisations.
            </p>
            <p>
              My expertise lies in designing multiple products, across the globe
              and in multiple domains – Operating Systems, Enterprise
              Applications, Financial Portals, Business and financial management
              solutions, Retail etc., across multiple platforms – Online,
              Desktop applications and now mobile applications.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row gap-12 items-start justify-between">
          <div className="md:w-1/3">
            ...
            <p className="text-neutral-500 max-w-xs">
              A comprehensive toolkit honed over a decade of hands-on experience
    ...
    <div className="max-w-4xl mx-auto px-6 py-20 flex flex-col gap-24">
      ...
      <section className="space-y-8">
        <h2 className="text-3xl md:text-4xl font-serif text-neutral-900">
          Brief about case study
        </h2>
        <div className="text-lg text-neutral-600 leading-relaxed space-y-6">
          <p>
            The increasing rate of private vehicle usage in the urban areas as a
            result of rapid economic and population growth is making vehicle
            parking one of the main concerns for the government.
          </p>
          <p>
            Today, we face tremendous pressure on parking spaces resulting in
            issues like traffic congestion, illegal parking, parking brawls,
            etc. to name a few.
          </p>
          <div className="bg-neutral-50 p-8 border-l-4 border-blue-600 rounded-r-xl">
            <p className="italic text-neutral-800 font-medium">
              "Being a resident where I located, I find looking for a parking
              spot extremely difficult especially if I am in a hurry. I couldn't
              find a resource at my disposal that could help me combat this
              issue, hence I have tried to solve the parking problem in this
              case study."
            </p>
          </div>
        </div>
      ...
      <section className="space-y-8">
        ...
        <p className="text-lg text-neutral-600">
          As initial research, I went online to search about Competitors apps
          and also interviewed some users to understand pain points.
        </p>

        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h3 className="text-xl font-bold uppercase tracking-widest text-neutral-400">
              Key Findings
            </h3>
      ...
      <section className="space-y-8">
        ...
        <p className="text-lg text-neutral-600 leading-relaxed">
          I have been following some users using indirect/shadowing method.
          After analysing user needs I found some key findings.
        </p>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={i}
              className="bg-rose-500 text-white p-6 rounded-xl flex items-center justify-center text-center font-medium shadow-sm hover:scale-105 transition-transform"
            >
              {task}
            </div>
          ))}
      ...
      <section className="space-y-8">
        ...
        <p className="text-lg text-neutral-600 leading-relaxed">
          Generally all the below data has to be collected by doing qualitative
          and quantitative data gathering methods, and then have to derive a
          pattern and ultimately use this data to understand the mental model of
          the users. By using all the below data we can create personas for
          every profile and we can also create empathy map to dive deep into the
          emotional part of the users.
        </p>
        <p className="text-sm text-neutral-500 italic mb-6">
          * But as the assignment describes quite deep enough information to
          create a persona i am assuming the below data would be an average all
          the users sample
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            >
              <h3 className="text-xl font-bold font-serif mb-3 text-blue-900">
                {profile.title}
              </h3>
          ...
          <table className="w-full min-w-[600px] text-left border-collapse">
            <thead>
              <tr className="bg-neutral-50 border-b border-neutral-200">
                <th className="p-4 text-sm font-bold uppercase tracking-widest text-neutral-500">
                  Characteristic
                </th>
                <th className="p-4 text-sm font-bold uppercase tracking-widest text-blue-900">
                  Transport People
                </th>
                <th className="p-4 text-sm font-bold uppercase tracking-widest text-blue-900">
                  Cab Drivers
            ...
            <tbody className="divide-y divide-neutral-100">
              {[
                ...
                {
                  label: "Tech Literacy",
                  val1: "Low to Moderate",
                  val2: "High (App usage)",
                  val3: "Moderate to High",
                },
                {
                  label: "Pain Points",
                  val1: "Finding large spots",
                  val2: "Traffic & fines",
                  val3: "Safety & Distance",
                },
                {
                  label: "Motivation",
                  val1: "Rest & Safety",
                ...
                },
                {
                  label: "Usage Freq",
                  val1: "Daily / Nightly",
                  val2: "Multiple times/day",
                  val3: "Occasional / Daily",
                },
              ].map((row, i) => (
                <tr key={i} className="hover:bg-neutral-50/50">
                  <td className="p-4 font-medium text-neutral-900 bg-neutral-50/30">
                    {row.label}
                  </td>
      ...
      <section className="space-y-8">
        ...
        <p className="text-lg text-neutral-600 leading-relaxed">
          In order to get a deeper Understanding about user behaviour and
          decisions, I used empathy mapping method.
        </p>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-blue-50 p-8 rounded-2xl border border-blue-100 flex flex-col gap-4">
            <h3 className="text-lg font-bold uppercase tracking-widest text-blue-900">
              Says
            </h3>
          ...
          <div className="bg-purple-50 p-8 rounded-2xl border border-purple-100 flex flex-col gap-4">
            <h3 className="text-lg font-bold uppercase tracking-widest text-purple-900">
              Thinks
            </h3>
            <ul className="list-disc list-inside space-y-2 text-neutral-700">
          ...
          <div className="bg-green-50 p-8 rounded-2xl border border-green-100 flex flex-col gap-4">
            <h3 className="text-lg font-bold uppercase tracking-widest text-green-900">
              Does
            </h3>
            <ul className="list-disc list-inside space-y-2 text-neutral-700">
          ...
          <div className="bg-orange-50 p-8 rounded-2xl border border-orange-100 flex flex-col gap-4">
            <h3 className="text-lg font-bold uppercase tracking-widest text-orange-900">
              Feels
            </h3>
            <ul className="list-disc list-inside space-y-2 text-neutral-700">
      ...
      <section className="space-y-12">
        ...
        <p className="text-lg text-neutral-600 leading-relaxed">
          After understanding I jump into user journey. Here is the steps for
          user to use app.
        </p>
          ...
          <div className="space-y-8 md:space-y-12 relative">
            ...
            <div className="relative md:pl-24">
              <div className="hidden md:flex absolute left-0 top-0 w-16 h-16 bg-blue-50 rounded-full items-center justify-center border-4 border-white shadow-sm z-10">
                <span className="text-blue-600 font-bold font-serif text-xl">
                  01
                </span>
              </div>
              <div className="bg-white p-6 md:p-8 rounded-2xl border border-neutral-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  <div className="px-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-sm font-medium text-neutral-700">
                    Start
                  </div>
                  ...
                  <ArrowRight className="text-neutral-300" size={16} />
                  <div className="px-4 py-2 bg-blue-50 border border-blue-100 rounded-lg text-sm font-bold text-blue-700">
                    Sign Up / Sign In
                  </div>
                </div>
              </div>
            ...
            <div className="relative md:pl-24">
              <div className="hidden md:flex absolute left-0 top-0 w-16 h-16 bg-green-50 rounded-full items-center justify-center border-4 border-white shadow-sm z-10">
                <span className="text-green-600 font-bold font-serif text-xl">
                  04
                </span>
              </div>
              <div className="bg-white p-6 md:p-8 rounded-2xl border border-neutral-200 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="flex flex-wrap gap-3 items-center">
                  ...
                  <ArrowRight className="text-neutral-300" size={16} />
                  <div className="px-4 py-2 bg-green-500 text-white rounded-lg text-sm font-bold shadow-lg shadow-green-200">
                    Park Vehicle
                  </div>
                </div>
              </div>
      ...
      <section className="space-y-12">
        ...
        <p className="text-lg text-neutral-600 leading-relaxed">
          Information architecture is a practise of deciding how to arrange a
          parts of something to be understandable. IA aims at organizing content
          so that user Would easily adjust to the functionality of the product
          and could find everything we need without big effect
        </p>
              ...
              <div className="grid grid-cols-4 gap-4">
                ...
                <div className="flex flex-col items-center relative pt-8">
                  ...
                  <div className="bg-white border border-neutral-200 p-6 rounded-2xl shadow-sm w-full text-center hover:shadow-lg transition-all hover:-translate-y-1">
                    ...
                    <div className="font-bold text-neutral-900 mb-3 text-lg">
                      Home
                    </div>
                    <div className="flex flex-wrap justify-center gap-2">
                      <span className="text-[10px] uppercase font-bold text-neutral-500 bg-neutral-100 py-1 px-2 rounded">
                        Search
                      </span>
                      <span className="text-[10px] uppercase font-bold text-neutral-500 bg-neutral-100 py-1 px-2 rounded">
                        Filter
      ...
      <section className="space-y-12">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <div className="bg-white p-8 rounded-xl border border-neutral-200 shadow-sm">
            <h3 className="text-xl font-bold font-serif mb-6 text-neutral-800">
              The Design Process
            </h3>
            <div className="flex flex-col gap-4">
              {[
                {
                  step: "01",
                  title: "Empathize",
                  desc: "User Research, Interviews, Competitor Analysis",
                },
                {
                  step: "02",
                  title: "Define",
                  desc: "User Personas, Empathy Maps, Problem Statements",
                },
                {
                  step: "03",
                  title: "Ideate",
                  desc: "Brainstorming, User Flows, Information Architecture",
                },
                {
                  step: "04",
                  title: "Prototype",
                  desc: "Wireframing, High-Fidelity Mockups, Interactions",
                },
                {
                  step: "05",
                  title: "Test",
                  desc: "Usability Testing, Feedback Iteration",
                },
              ].map((item, idx) => (
                <div key={idx} className="flex gap-4 items-start">
                  <span className="text-2xl font-serif text-neutral-300 font-bold">
                    {item.step}
                  </span>
                  <div>
          ...
          <div className="bg-blue-900 text-white p-8 rounded-xl shadow-md flex flex-col justify-between">
            <div>
              ...
              <p className="text-blue-100 mb-8 leading-relaxed">
                Bridging the gap between drivers needing space and space owners
                needing utilization. ParkMe creates a seamless ecosystem for
                urban mobility.
              </p>
            </div>
            <div className="space-y-4">
              ...
              <div className="bg-white/10 p-4 rounded-lg backdrop-blur-sm">
                ...
                <p className="text-sm text-blue-200">
                  Monetize unused space effectively.
                </p>
              </div>
            </div>
          </div>
          ...
          <table className="w-full min-w-[600px] text-left border-collapse">
            <thead>
              <tr className="bg-neutral-50 border-b border-neutral-200">
                ...
                <th className="p-4 text-sm font-bold uppercase tracking-widest text-blue-600">
                  ParkMe
                </th>
                <th className="p-4 text-sm font-bold uppercase tracking-widest text-neutral-600">
                  Google Maps
                </th>
                <th className="p-4 text-sm font-bold uppercase tracking-widest text-neutral-600">
                  Traditional
            ...
            <tbody className="divide-y divide-neutral-100">
              {[
                ...
                <tr key={i} className="hover:bg-neutral-50/50">
                  ...
                  <td className="p-4 text-center">
                    {row.google ? (
                      <span className="inline-block w-6 h-6 bg-neutral-100 text-neutral-600 rounded-full flex items-center justify-center">
                        ✓
                      </span>
                    ) : (
                      <span className="text-neutral-300">-</span>
      ...
      <section className="space-y-8">
        <div className="bg-black text-white p-8 md:p-12 rounded-3xl">
          <div className="flex flex-col md:flex-row justify-between items-start mb-12 gap-8">
            <div className="max-w-xl">
              ...
              <p className="text-neutral-300 leading-relaxed text-lg">
                In order to build a seamless and hassle-free experience for all
                the people who struggle to find parking spots for their
                vehicles, I designed ParkMe mobile app keeping the user needs
          ...
          <div className="bg-neutral-900 rounded-3xl overflow-hidden mb-12 border border-neutral-800 shadow-2xl">
            <img
              src={parkMeScreens}
              alt="ParkMe Mobile App Interface Screens"
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-neutral-900/50 p-6 rounded-2xl border border-neutral-800">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                Real-time visualization of parking zones showing exactly which
                spots are free (e.g., "4 Slots Free"). Users can choose their
                preferred location before arriving.
              </p>
            </div>
            ...
            <div className="bg-neutral-900/50 p-6 rounded-2xl border border-neutral-800">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                One-tap booking system with clear location details like "Plot No
                - M03, Sector 18, Noida". The interface provides instant
                confirmation for your selected zone.
              </p>
            </div>
            ...
            <div className="bg-neutral-900/50 p-6 rounded-2xl border border-neutral-800">
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                Active tracking of parking duration with a clear countdown timer
                ("35 M : 21 S"). Users can monitor their session and easily stop
                the meter when they leave.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-xl border border-neutral-200 shadow-sm mb-8">
          <h4 className="font-bold mb-4 text-sm uppercase tracking-widest text-neutral-500">
            Legend
          </h4>
          <div className="grid md:grid-cols-2 gap-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm text-neutral-600">
                Problems occurred which delayed the test participant in carrying
                out the task.
              </span>
            </div>
            <div className="flex items-start gap-3">
              ...
              />
              <span className="text-sm text-neutral-600">
                The test participant encountered considerable problems but
                eventually succeeded in completing the task correctly.
              </span>
            </div>
            <div className="flex items-start gap-3">
              <XCircle className="text-red-500 flex-shrink-0" size={20} />
              <span className="text-sm text-neutral-600">
                The test participant was unable to complete the task or arrived
                at a result that deviated significantly from the correct result.
              </span>
            </div>
            <div className="flex items-start gap-3">
              <AlertOctagon className="text-red-600 flex-shrink-0" size={20} />
              <span className="text-sm text-neutral-600">
                The test participant arrived at a result that posed an
                existential threat to the test participant or other human
                beings.
              </span>
            </div>
          </div>
          ...
          <table className="w-full min-w-[800px] text-left border-collapse">
            <thead>
              <tr className="bg-blue-900 text-white">
                <th className="p-4 text-sm font-bold uppercase tracking-widest w-16">
                  Task
                </th>
                <th className="p-4 text-sm font-bold uppercase tracking-widest">
                  Details
                </th>
                <th className="p-4 text-sm font-bold uppercase tracking-widest w-16 text-center">
                  P1
                </th>
                <th className="p-4 text-sm font-bold uppercase tracking-widest w-16 text-center">
                  P2
            ...
            <tbody className="divide-y divide-neutral-100">
              ...
              <tr className="hover:bg-neutral-50/50">
                ...
                <td className="p-4 text-neutral-700">
                  Are you finding free / parking slots
                </td>
                <td className="p-4 text-center">
                  <CheckCircle2 className="text-green-500 mx-auto" size={20} />
                </td>
              ...
              <tr className="hover:bg-neutral-50/50">
                ...
                <td className="p-4 text-neutral-700">
                  Are you able to complete selecting slot and payment
                </td>
                <td className="p-4 text-center">
                  <CheckCircle2 className="text-green-500 mx-auto" size={20} />
                </td>
              ...
              <tr className="hover:bg-neutral-50/50">
                ...
                <td className="p-4 text-neutral-700">
                  Navigation & Calling Parking premises people
                </td>
                <td className="p-4 text-center">
                  <CheckCircle2 className="text-green-500 mx-auto" size={20} />
                </td>
...
const Portfolio = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      category: "Branding",
      image:
        "https://images.unsplash.com/photo-1588780383829-2e16c0085c62?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxoZWFkcGhvbmVzJTIwZGFyayUyMG5lb24lMjBtdXNpYyUyMHN0dWRpb3xlbnwxfHx8fDE3NzE1MDMyOTJ8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    },
    {
      ...
      category: "Mobile App",
      image:
        "https://images.unsplash.com/photo-1691647432227-0c084e0ad818?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0cmF2ZWwlMjBhcHAlMjBhZHZlbnR1cmUlMjBtb3VudGFpbnMlMjBsYW5kc2NhcGV8ZW58MXx8fHwxNzcxNTA1NzQyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    },
    {
      ...
      category: "Health",
      image:
        "https://images.unsplash.com/photo-1758466872243-496929504a0b?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx5b2dhJTIwbWVkaXRhdGlvbiUyMHJldHJlYXQlMjBwZWFjZWZ1bCUyMHN0dWRpb3xlbnwxfHx8fDE3NzE1MDU3NDV8MA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    },
    {
      ...
      category: "Web Design",
      image:
        "https://images.unsplash.com/photo-1757439402103-fc35542f96f8?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxtaW5pbWFsJTIwZnVybml0dXJlJTIwbHV4dXJ5JTIwaW50ZXJpb3IlMjBkZXNpZ258ZW58MXx8fHwxNzcxNTA1NzQ4fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral",
    ...
    <section id="portfolio" className="py-20 px-6 md:px-12 max-w-7xl mx-auto">
      ...
      <div className="flex justify-between items-end mb-12">
        ...
        <p className="text-sm text-neutral-500 max-w-xs text-right">
          Explore my recent web design creations and discover how we can
          ...
          >
            ...
            <div className="border-t border-neutral-300 pt-4">
              ...
              <div className="flex justify-between items-center">
                <p className="text-neutral-500 text-sm truncate pr-4">
                  {project.description}
                </p>
                <span className="bg-neutral-100 text-neutral-600 px-3 py-1 rounded-full text-[10px] uppercase tracking-widest font-bold whitespace-nowrap">
                  {project.category}
                </span>
              </div>
            </div>
...
const Contact = () => {
  return (
    <section
      id="contact"
      className="py-20 px-6 md:px-12 max-w-7xl mx-auto bg-white/40 backdrop-blur-sm rounded-3xl mb-12"
    >
          ...
          <div className="space-y-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <a
                  href="mailto:hello@mohanpatcha.com"
                  className="text-neutral-600 hover:text-black transition-colors"
                >
                  hello@mohanpatcha.com
                </a>
              </div>
            </div>
